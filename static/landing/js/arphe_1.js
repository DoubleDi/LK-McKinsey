            ...
            for (var l = 0; l < group.children[i].geometry.vertices.length; l++) {
                ...
                */
                ...
                if ( (Math.abs(x - mouseMesh.position.x) < 10) && (Math.abs(y -  mouseMesh.position.y) < 10) ) {
                    ...
                    if (group.children[i].geometry.vertices[l].x - mouseMesh.position.x > 0 ) {
                    ...
                    if (group.children[i].geometry.vertices[l].y - mouseMesh.position.y > 0 ) {
                        new TWEEN.Tween(group.children[i].geometry.vertices[l]).to({
                            y: y+10,
                            z: z-10
                        }, 1000)
                    ...
                    var speed = 0;
                    if (x > x_orig) {
                        group.children[i].geometry.vertices[l].x -= 0.02;
                    }
                    else if (x < x_orig) {
                        group.children[i].geometry.vertices[l].x += 0.02;
                    }
                    ...
                    if (y > y_orig) {
                        group.children[i].geometry.vertices[l].y -= 0.02;
                    }
                    else if (y < y_orig) {
                        group.children[i].geometry.vertices[l].y += 0.02;
                    }
                    ...
                    if (z > y_orig) {
                        group.children[i].geometry.vertices[l].z -= 0.02;
                    }
                    else if (z < z_orig) {
                        group.children[i].geometry.vertices[l].z += 0.02;
                    }
    ...
    function hazars() {
        ...
        for (var i = 0; i < 2000; i++) {
            ...
            for (var l =0; l<1;l++) {
                ...
                star.x = 1 * Math.sin(rad + (i * 0.03)) * RADIUS - Math.cos(rad + (i * 0.05)) * RADIUS ;
                star.z = 1 * Math.cos(rad + (i * 0.03)) * RADIUS - Math.sin(rad + (i * 0.05)) * RADIUS ;
                ...
                */
                ...
                if (i>3) {
                    for (var l=0;l<1;l++) {
                        ...
                        var number = parseInt(Math.random() * 200);

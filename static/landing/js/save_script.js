function init() {
    ...
    function init() {
        ...
        */
        ...
        mouseGeometry = new THREE.SphereGeometry(1, 0, 0);
    ...
    */
    ...
    var static_numbers = {};
    static_numbers.y = 100;
    
    
    camera.position.set(-35,-35,190)
        ...
        for (var i = 0; i < group.children.length; i++) {
            ...
            for (var l = 0; l < group.children[i].geometry.vertices.length; l++) {
                ...
                */
                ...
                if ( (Math.abs(x - mouseMesh.position.x) < 15) && (Math.abs(y -  mouseMesh.position.y) < 15) ) {
    ...
    function render() {
        ...
        */
        ...
        camera.position.y += static_numbers.y * 0.05;
        ...
        camera.lookAt(new THREE.Vector3(20, static_numbers.y, 0));
    ...
    function hazars(width = 10,wireframe=true) {
        ...
        for (var i = 0; i < 800; i++) {
            ...
            for (var l =0; l<1;l++) {
                ...
                star.x =  1 * Math.sin(rad + (i * 0.03)) * RADIUS + Math.random() * RADIUS * Math.sin(rad + (i * i * 0.03))  * Math.sin(rad + (i * 0.02)) - Math.random() * RADIUS * Math.sin(rad + (i * i * 0.02));
                
                star.z = 0.5 * Math.cos(rad + (i * 0.05)) * RADIUS + Math.random() * RADIUS - Math.random() * RADIUS;
                star.y = x_old + Math.random() * l  ;
    ...
    return [new_group, camera, orig_array, static_numbers];

};

var star_systems = init();
var chain = star_systems[0];
var camera = star_systems[1];
var chain_array = star_systems[2];
var static_numbers = star_systems[3];
